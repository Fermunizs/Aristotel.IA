...
const NAV = [
  ...
  { href: "/conversar", label: "Conversar", icon: ConversarIcon },
  { href: "/lembretes", label: "Lembretes", icon: LembreteIcon },
  { href: "/evolucao", label: "Evolução", icon: EvolucaoIcon },
  { href: "/ajustes", label: "Ajustes", icon: AjusteUserIcon },
];
...
export function Sidebar({
  ...
  if (!impersonating && role === "superadmin") {
    items.push({ href: "/admin/retencao", label: "Retenção", icon: RetencaoIcon });
    items.push({ href: "/admin/consumo", label: "Consumo", icon: ConsumoIcon });
    items.push({ href: "/admin/servidor", label: "Servidor", icon: ServidorIcon });
...
function ConversarIcon() { return <svg {...S}><path d="M4 12a7 7 0 0 1 7-7h2a7 7 0 0 1 0 14H7l-3 3z" /></svg>; }
...
function RetencaoIcon() { return <svg {...S}><path d="M4 18c4 0 5-11 8-11s3 7 8 7" /><path d="M4 21h16" /></svg>; }
function ServidorIcon() { return <svg {...S}><rect x="3" y="4" width="18" height="7" rx="1.5" /><rect x="3" y="13" width="18" height="7" rx="1.5" /><path d="M7 7.5h.01M7 16.5h.01" /></svg>; }
